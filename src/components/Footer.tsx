    ...
    <footer className="bg-charcoal text-ivory mt-24 grain">
      <Container className="py-20 md:py-24 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-14 lg:gap-10">
        <div className="lg:col-span-2">
          ...
          <p className="text-ivory/70 text-sm leading-relaxed max-w-sm">{siteConfig.description}</p>
        </div>
        ...
        <div className="lg:col-span-2">
          ...
          <div className="flex gap-6 mt-4 mb-8">
            <a
              ...
              className="text-[11px] uppercase tracking-[0.22em] text-ivory/50 hover:text-gold"
            >
              Facebook
            </a>
            <a
